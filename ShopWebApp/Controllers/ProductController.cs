...
namespace ShopWebApp.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            if (id == null)
            {
                // eto zapros na sozdanie nowoj susznosti
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    //update
                    var objFromDb = _db.Product.AsNoTracking().FirstOrDefault(u => u.Id == productVM.Product.Id); // izwlecz z bd
                    ...
                    _db.Product.Update(productVM.Product); // jest osleziwanie<kak otkluczit???
